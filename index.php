                                ...
                                <div class="box-3 float-container">
                                    <?php 
                                        ...
                                        else
                                        {
                                            //Image Available
                                            ?>
                                            <img src="<?php echo SITEURL; ?>images/category/<?php echo $image_name; ?>" alt="Pizza" class="img-responsive img-curve category-img">
                                            <?php
                                        }
                                    ?>
    ...
    <section class="food-menu">
        <div class="container food-menu-container">
            <h2 class="text-center food-menu-title">Confira Nosso Menu!</h2>
                ...
                while($row=mysqli_fetch_assoc($res2))
                {
                    ...
                    <div class="food-menu-box">
                        ...
                        <div class="food-menu-desc">
                            ...
                            <a href="<?php echo SITEURL; ?>order.php?food_id=<?php echo $id; ?>" class="btn btn-primary">Pedir Agora</a>
                        </div>
                    </div>
        ...
        <p class="text-center menu-completo-link">
            <a href="#" class="menu-completo-link">Veja nosso menu completo!</a>
        </p>
    </section>
