        ...
        <?php 
            ...
            if(isset($_GET['id']))
            {
                ...
                else
                {
                    ...
                    $_SESSION['no-category-found'] = "<div class='error'>Category não Encontrada.</div>";
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name != "")
                    {
                        ...
                        {
                            //SEt message
                            $_SESSION['upload'] = "<div class='error'>Erro ao enviar Imagem. </div>";
                        ...
                        if($current_image!="")
                        {
                            ...
                            if($remove==false)
                            {
                                ...
                                $_SESSION['failed-remove'] = "<div class='error'>Erro ao remover Imagem.</div>";
                                header('location:'.SITEURL.'admin/manage-category.php');
