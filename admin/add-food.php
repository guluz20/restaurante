        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <table class="tbl-30">
                ...
                <tr>
                    <td>Descrição: </td>
                    <td>
                        <textarea name="description" cols="30" rows="5" placeholder="Descrição do prato."></textarea>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        <input type="submit" name="submit" value="Adicionar Prato" class="btn-secondary">
                    </td>
                </tr>
        ...
        <?php 
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        if($upload==false)
                        {
                            ...
                            $_SESSION['upload'] = "<div class='error'>Falha ao enviar imagem.</div>";
                ...
                if($res2 == true)
                {
                    ...
                    $_SESSION['add'] = "<div class='success'>Prato Adicionado Com sucesso.</div>";
                    header('location:'.SITEURL.'admin/manage-food.php');
                }
                else
                {
                    //FAiled to Insert Data
                    $_SESSION['add'] = "<div class='error'>Erro ao adicionar prato.</div>";
                    header('location:'.SITEURL.'admin/manage-food.php');
                }
