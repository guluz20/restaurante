        ...
        <form action="" method="POST">
            ...
            <table class="tbl-30">
                ...
                <tr>
                    ...
                    <td>
                        <select name="status">
                            <option <?php if($status=="Pedido Realizado"){echo "selected";} ?> value="Pedido Realizado">Pedido Realizado</option>
                            <option <?php if($status=="A caminho de entrega"){echo "selected";} ?> value="A caminho de entrega">A caminho de entrega</option>
